class UserSettlement
  ...
  def save
    ...
    # 住所の情報を保存
    Purchase.create(postal_code: postal_code, shipment_source_area_id: shipment_source_area_id, address: address, phone_number: phone_number, building_name: building_name, municipality: municipality, buyer_management_id: buyer_management.id)
  end
end
